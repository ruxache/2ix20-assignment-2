...
{	Trans *T;
	...
	trans[3][1]	= settr(285,2,2,3,3,"(run main_control())", 1, 2, 0);
	trans[3][2]	= settr(286,2,14,4,4,"proc = 0", 1, 2, 0);
	...
	trans[3][3]	= settr(287,2,10,5,5,"((proc<3))", 1, 2, 0); /* m: 4 -> 10,0 */
	reached3[4] = 1;
	...
	trans[3][10]	= settr(294,2,11,6,6,"(run lock(proc))", 1, 2, 0);
	trans[3][11]	= settr(295,2,14,7,7,"proc = (proc+1)", 1, 2, 0);
	trans[3][12]	= settr(296,2,25,8,8,"((proc==3))", 1, 2, 0); /* m: 17 -> 25,0 */
	reached3[17] = 1;
	trans[3][13]	= settr(297,2,17,1,0,"goto :b7", 1, 2, 0); /* m: 17 -> 0,25 */
	reached3[17] = 1;
	trans[3][16]	= settr(300,2,17,1,0,"break", 1, 2, 0);
	trans[3][17]	= settr(301,2,25,9,9,"proc = 0", 1, 2, 0);
	...
	trans[3][18]	= settr(302,2,21,10,10,"((proc<2))", 1, 2, 0); /* m: 19 -> 21,0 */
	reached3[19] = 1;
	trans[3][19]	= settr(0,0,0,0,0,"ship_status[proc] = 3",0,0,0);
	trans[3][20]	= settr(0,0,0,0,0,"ship_pos[proc] = 0",0,0,0);
	trans[3][21]	= settr(305,2,22,11,11,"(run ship(proc))", 1, 2, 0);
	trans[3][22]	= settr(306,2,25,12,12,"proc = (proc+1)", 1, 2, 0);
	trans[3][23]	= settr(307,2,34,13,13,"((proc==2))", 1, 2, 0); /* m: 28 -> 34,0 */
	reached3[28] = 1;
	trans[3][24]	= settr(308,2,28,1,0,"goto :b8", 1, 2, 0); /* m: 28 -> 0,34 */
	reached3[28] = 1;
	trans[3][27]	= settr(311,2,28,1,0,"break", 1, 2, 0);
	trans[3][28]	= settr(312,2,34,14,14,"proc = 0", 1, 2, 0);
	...
	trans[3][29]	= settr(313,2,34,15,15,"((proc<2))", 1, 2, 0); /* m: 30 -> 34,0 */
	reached3[30] = 1;
	...
	trans[3][38]	= settr(322,0,0,16,16,"-end-", 0, 3500, 0);
	...
	trans[2][1]	= settr(169,0,28,17,17,"request_low?1,lockid", 1, 503, 0);
	T = trans[2][28] = settr(196,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(196,0,2,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(196,0,26,0,0,"IF", 0, 2, 0);
	trans[2][2]	= settr(170,0,8,18,0,"((doors_status[lockid].lower==2))", 1, 2, 0);
	T = trans[2][8] = settr(176,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(176,0,3,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(176,0,6,0,0,"IF", 0, 2, 0);
	trans[2][3]	= settr(171,0,4,19,0,"((slide_status[lockid].higher==1))", 1, 2, 0);
	trans[2][4]	= settr(172,0,5,20,20,"change_slide_pos[lockid]!1", 1, 9, 0);
	trans[2][5]	= settr(173,0,15,21,21,"slide_pos_changed[lockid]?1", 1, 510, 0);
	trans[2][9]	= settr(177,0,15,1,0,".(goto)", 0, 2, 0);
	trans[2][6]	= settr(174,0,7,22,0,"((slide_status[lockid].higher==2))", 1, 2, 0);
	...
	trans[2][10]	= settr(178,0,11,23,0,"((doors_status[lockid].higher==1))", 1, 2, 0);
	trans[2][11]	= settr(179,0,12,24,24,"change_doors_pos[lockid]!1", 1, 7, 0);
	trans[2][12]	= settr(180,0,22,25,25,"doors_pos_changed[lockid]?1", 1, 508, 0);
	trans[2][16]	= settr(184,0,22,1,0,".(goto)", 0, 2, 0);
	trans[2][13]	= settr(181,0,14,26,0,"((doors_status[lockid].higher==2))", 1, 2, 0);
	...
	trans[2][17]	= settr(185,0,18,27,0,"((slide_status[lockid].lower==2))", 1, 2, 0);
	trans[2][18]	= settr(186,0,19,28,28,"change_slide_pos[lockid]!2", 1, 9, 0);
	trans[2][19]	= settr(187,0,24,29,29,"slide_pos_changed[lockid]?1", 1, 510, 0);
	trans[2][23]	= settr(191,0,24,1,0,".(goto)", 0, 2, 0);
	trans[2][20]	= settr(188,0,21,30,0,"((slide_status[lockid].lower==1))", 1, 2, 0);
	...
	trans[2][32]	= settr(200,0,38,36,0,"((doors_status[lockid].higher==2))", 1, 2, 0);
	T = trans[2][38] = settr(206,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(206,0,33,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(206,0,36,0,0,"IF", 0, 2, 0);
	trans[2][33]	= settr(201,0,34,37,0,"((slide_status[lockid].lower==1))", 1, 2, 0);
	trans[2][34]	= settr(202,0,35,38,38,"change_slide_pos[lockid]!2", 1, 9, 0);
	trans[2][35]	= settr(203,0,45,39,39,"slide_pos_changed[lockid]?1", 1, 510, 0);
	trans[2][39]	= settr(207,0,45,1,0,".(goto)", 0, 2, 0);
	trans[2][36]	= settr(204,0,37,40,0,"((slide_status[lockid].lower==2))", 1, 2, 0);
	...
	trans[2][40]	= settr(208,0,41,41,0,"((doors_status[lockid].lower==1))", 1, 2, 0);
	trans[2][41]	= settr(209,0,42,42,42,"change_doors_pos[lockid]!2", 1, 7, 0);
	trans[2][42]	= settr(210,0,52,43,43,"doors_pos_changed[lockid]?1", 1, 508, 0);
	trans[2][46]	= settr(214,0,52,1,0,".(goto)", 0, 2, 0);
	trans[2][43]	= settr(211,0,44,44,0,"((doors_status[lockid].lower==2))", 1, 2, 0);
	...
	trans[2][47]	= settr(215,0,48,45,0,"((slide_status[lockid].higher==2))", 1, 2, 0);
	trans[2][48]	= settr(216,0,49,46,46,"change_slide_pos[lockid]!1", 1, 9, 0);
	trans[2][49]	= settr(217,0,54,47,47,"slide_pos_changed[lockid]?1", 1, 510, 0);
	trans[2][53]	= settr(221,0,54,1,0,".(goto)", 0, 2, 0);
	trans[2][50]	= settr(218,0,51,48,0,"((slide_status[lockid].higher==1))", 1, 2, 0);
	trans[2][51]	= settr(219,0,54,1,0,"(1)", 0, 2, 0);
	trans[2][54]	= settr(222,0,55,49,49,"change_doors_pos[lockid]!1", 1, 7, 0);
	trans[2][55]	= settr(223,0,60,50,50,"doors_pos_changed[lockid]?1", 1, 508, 0);
	trans[2][59]	= settr(227,0,60,1,0,".(goto)", 0, 2, 0);
	trans[2][56]	= settr(224,0,57,51,0,"((doors_status[lockid].higher==1))", 1, 2, 0);
	trans[2][57]	= settr(225,0,60,1,0,"(1)", 0, 2, 0);
	trans[2][60]	= settr(228,0,113,52,52,"observed_high[lockid]?1", 1, 506, 0);
	trans[2][61]	= settr(229,0,85,53,53,"request_low?0,lockid", 1, 503, 0);
	T = trans[2][85] = settr(253,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(253,0,62,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(253,0,83,0,0,"IF", 0, 2, 0);
	trans[2][62]	= settr(230,0,81,54,0,"(lock_is_occupied[lockid])", 1, 2, 0);
	T = trans[2][81] = settr(249,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(249,0,63,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(249,0,73,0,0,"IF", 0, 2, 0);
	trans[2][63]	= settr(231,0,69,55,0,"((doors_status[lockid].lower==1))", 1, 2, 0);
	T = trans[2][69] = settr(237,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(237,0,64,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(237,0,67,0,0,"IF", 0, 2, 0);
	trans[2][64]	= settr(232,0,65,56,0,"((slide_status[lockid].lower==1))", 1, 2, 0);
	trans[2][65]	= settr(233,0,66,57,57,"change_slide_pos[lockid]!2", 1, 9, 0);
	trans[2][66]	= settr(234,0,71,58,58,"slide_pos_changed[lockid]?1", 1, 510, 0);
	trans[2][70]	= settr(238,0,71,1,0,".(goto)", 0, 2, 0);
	trans[2][67]	= settr(235,0,68,59,0,"((slide_status[lockid].lower==2))", 1, 2, 0);
	trans[2][68]	= settr(236,0,71,1,0,"(1)", 0, 2, 0);
	trans[2][71]	= settr(239,0,72,60,60,"change_doors_pos[lockid]!2", 1, 7, 0);
	trans[2][72]	= settr(240,0,113,61,61,"doors_pos_changed[lockid]?1", 1, 508, 0);
	trans[2][82]	= settr(250,0,113,1,0,".(goto)", 0, 2, 0);
	trans[2][73]	= settr(241,0,79,62,0,"((doors_status[lockid].lower==2))", 1, 2, 0);
	T = trans[2][79] = settr(247,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(247,0,74,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(247,0,77,0,0,"IF", 0, 2, 0);
	trans[2][74]	= settr(242,0,75,63,0,"((slide_status[lockid].lower==1))", 1, 2, 0);
	trans[2][75]	= settr(243,0,76,64,64,"change_slide_pos[lockid]!2", 1, 9, 0);
	trans[2][76]	= settr(244,0,113,65,65,"slide_pos_changed[lockid]?1", 1, 510, 0);
	trans[2][80]	= settr(248,0,113,1,0,".(goto)", 0, 2, 0);
	trans[2][77]	= settr(245,0,78,66,66,"((slide_status[lockid].lower==2))", 1, 2, 0);
	trans[2][78]	= settr(246,0,113,1,0,"(1)", 0, 2, 0);
	trans[2][86]	= settr(254,0,113,1,0,".(goto)", 0, 2, 0);
	trans[2][83]	= settr(251,0,84,67,67,"(!(lock_is_occupied[lockid]))", 1, 2, 0);
	trans[2][84]	= settr(252,0,113,1,0,"(1)", 0, 2, 0);
	trans[2][87]	= settr(255,0,111,68,68,"request_high?0,lockid", 1, 504, 0);
	T = trans[2][111] = settr(279,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(279,0,88,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(279,0,109,0,0,"IF", 0, 2, 0);
	trans[2][88]	= settr(256,0,107,69,0,"(lock_is_occupied[lockid])", 1, 2, 0);
	T = trans[2][107] = settr(275,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(275,0,89,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(275,0,99,0,0,"IF", 0, 2, 0);
	trans[2][89]	= settr(257,0,95,70,0,"((doors_status[lockid].higher==1))", 1, 2, 0);
	T = trans[2][95] = settr(263,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(263,0,90,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(263,0,93,0,0,"IF", 0, 2, 0);
	trans[2][90]	= settr(258,0,91,71,0,"((slide_status[lockid].higher==1))", 1, 2, 0);
	trans[2][91]	= settr(259,0,92,72,72,"change_slide_pos[lockid]!1", 1, 9, 0);
	trans[2][92]	= settr(260,0,97,73,73,"slide_pos_changed[lockid]?1", 1, 510, 0);
	trans[2][96]	= settr(264,0,97,1,0,".(goto)", 0, 2, 0);
	trans[2][93]	= settr(261,0,94,74,0,"((slide_status[lockid].higher==2))", 1, 2, 0);
	trans[2][94]	= settr(262,0,97,1,0,"(1)", 0, 2, 0);
	trans[2][97]	= settr(265,0,98,75,75,"change_doors_pos[lockid]!1", 1, 7, 0);
	trans[2][98]	= settr(266,0,113,76,76,"doors_pos_changed[lockid]?1", 1, 508, 0);
	trans[2][108]	= settr(276,0,113,1,0,".(goto)", 0, 2, 0);
	trans[2][99]	= settr(267,0,105,77,0,"((doors_status[lockid].higher==2))", 1, 2, 0);
	T = trans[2][105] = settr(273,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(273,0,100,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(273,0,103,0,0,"IF", 0, 2, 0);
	trans[2][100]	= settr(268,0,101,78,0,"((slide_status[lockid].higher==1))", 1, 2, 0);
	trans[2][101]	= settr(269,0,102,79,79,"change_slide_pos[lockid]!1", 1, 9, 0);
	trans[2][102]	= settr(270,0,113,80,80,"slide_pos_changed[lockid]?1", 1, 510, 0);
	trans[2][106]	= settr(274,0,113,1,0,".(goto)", 0, 2, 0);
	trans[2][103]	= settr(271,0,104,81,81,"((slide_status[lockid].higher==2))", 1, 2, 0);
	trans[2][104]	= settr(272,0,113,1,0,"(1)", 0, 2, 0);
	trans[2][112]	= settr(280,0,113,1,0,".(goto)", 0, 2, 0);
	trans[2][109]	= settr(277,0,110,82,82,"(!(lock_is_occupied[lockid]))", 1, 2, 0);
	trans[2][110]	= settr(278,0,113,1,0,"(1)", 0, 2, 0);
	trans[2][115]	= settr(283,0,116,1,0,"break", 0, 2, 0);
	trans[2][116]	= settr(284,0,0,83,83,"-end-", 0, 3500, 0);
	...
	trans[1][1]	= settr(50,0,2,84,0,"(((ship_status[shipid]==5)&&(ship_pos[shipid]!=0)))", 1, 2, 0);
	trans[1][2]	= settr(51,0,24,85,85,"lockid = (ship_pos[shipid]-1)", 1, 2, 0);
	...
	trans[1][3]	= settr(52,0,4,86,0,"((doors_status[lockid].higher==2))", 1, 2, 0);
	trans[1][4]	= settr(53,0,5,87,87,"request_high!1,lockid", 1, 4, 0);
	trans[1][5]	= settr(54,0,17,88,88,"high_req[lockid] = 1", 1, 2, 0);
	T = trans[ 1][17] = settr(66,2,0,0,0,"ATOMIC", 1, 2, 0);
	T->nxt	= settr(66,2,6,0,0,"ATOMIC", 1, 6, 0);
	trans[1][6]	= settr(55,2,15,89,0,"((doors_status[lockid].higher==1))", 1, 6, 0);
	T = trans[1][15] = settr(64,2,0,0,0,"IF", 1, 6, 0);
	T = T->nxt	= settr(64,2,7,0,0,"IF", 1, 6, 0);
	    T->nxt	= settr(64,2,13,0,0,"IF", 1, 6, 0);
	trans[1][7]	= settr(56,2,11,90,90,"(!(lock_is_occupied[lockid]))", 1, 6, 0); /* m: 8 -> 11,0 */
	reached1[8] = 1;
	...
	trans[1][11]	= settr(60,2,12,91,91,"observed_high[lockid]!1", 1, 6, 0);
	trans[1][12]	= settr(61,0,116,1,0,"goto :b2", 1, 6, 0);
	trans[1][16]	= settr(65,0,24,1,0,".(goto)", 1, 6, 0);
	trans[1][13]	= settr(62,2,14,92,0,"(lock_is_occupied[lockid])", 1, 6, 0);
	trans[1][14]	= settr(63,2,16,93,93,"observed_high[lockid]!1", 1, 6, 0);
	T = trans[ 1][23] = settr(72,2,0,0,0,"ATOMIC", 1, 2, 0);
	T->nxt	= settr(72,2,18,0,0,"ATOMIC", 1, 2, 0);
	trans[1][18]	= settr(67,4,116,94,94,"(((doors_status[lockid].higher==1)&&!(lock_is_occupied[lockid])))", 1, 2, 0); /* m: 19 -> 116,0 */
	reached1[19] = 1;
	...
	trans[1][27]	= settr(76,0,52,95,0,"((ship_status[shipid]==4))", 1, 2, 0);
	...
	trans[1][28]	= settr(77,0,29,96,0,"((doors_status[lockid].lower==2))", 1, 2, 0);
	trans[1][29]	= settr(78,0,30,97,97,"request_low!1,lockid", 1, 3, 0);
	trans[1][30]	= settr(79,0,31,98,98,"requested_lock = lockid", 1, 2, 0);
	trans[1][31]	= settr(80,0,44,99,99,"low_req[lockid] = 1", 1, 2, 0);
	T = trans[ 1][44] = settr(93,2,0,0,0,"ATOMIC", 1, 2, 0);
	T->nxt	= settr(93,2,32,0,0,"ATOMIC", 1, 5, 0);
	trans[1][32]	= settr(81,2,42,100,0,"((doors_status[lockid].lower==1))", 1, 5, 0);
	T = trans[1][42] = settr(91,2,0,0,0,"IF", 1, 5, 0);
	T = T->nxt	= settr(91,2,33,0,0,"IF", 1, 5, 0);
	    T->nxt	= settr(91,2,40,0,0,"IF", 1, 5, 0);
	trans[1][33]	= settr(82,2,38,101,101,"(((nr_of_ships_at_pos[(ship_pos[shipid]-1)]<2)||((ship_pos[shipid]-1)==0)))", 1, 5, 0); /* m: 34 -> 38,0 */
	reached1[34] = 1;
	...
	trans[1][38]	= settr(87,2,39,102,102,"observed_low[0]!1", 1, 5, 0);
	trans[1][39]	= settr(88,0,116,1,0,"goto :b3", 1, 5, 0);
	trans[1][43]	= settr(92,0,52,1,0,".(goto)", 1, 5, 0);
	trans[1][40]	= settr(89,2,41,103,0,"(((nr_of_ships_at_pos[(ship_pos[shipid]-1)]==2)&&((ship_pos[shipid]-1)!=0)))", 1, 5, 0);
	trans[1][41]	= settr(90,2,43,104,104,"observed_low[0]!1", 1, 5, 0);
	T = trans[ 1][51] = settr(100,2,0,0,0,"ATOMIC", 1, 2, 0);
	T->nxt	= settr(100,2,45,0,0,"ATOMIC", 1, 2, 0);
	trans[1][45]	= settr(94,4,116,105,105,"(((doors_status[lockid].lower==1)&&((nr_of_ships_at_pos[(ship_pos[shipid]-1)]<2)||((ship_pos[shipid]-1)==0))))", 1, 2, 0); /* m: 46 -> 116,0 */
	reached1[46] = 1;
	...
	trans[1][55]	= settr(104,0,56,106,0,"(((ship_status[shipid]==3)&&(ship_pos[shipid]!=3)))", 1, 2, 0);
	trans[1][56]	= settr(105,0,79,107,107,"lockid = (ship_pos[shipid]+1)", 1, 2, 0);
	...
	trans[1][57]	= settr(106,0,58,108,0,"((doors_status[lockid].lower==2))", 1, 2, 0);
	trans[1][58]	= settr(107,0,59,109,109,"request_low!1,lockid", 1, 3, 0);
	trans[1][59]	= settr(108,0,60,110,110,"requested_lock = lockid", 1, 2, 0);
	trans[1][60]	= settr(109,0,72,111,111,"low_req[lockid] = 1", 1, 2, 0);
	T = trans[ 1][72] = settr(121,2,0,0,0,"ATOMIC", 1, 2, 0);
	T->nxt	= settr(121,2,61,0,0,"ATOMIC", 1, 5, 0);
	trans[1][61]	= settr(110,2,70,112,0,"((doors_status[lockid].lower==1))", 1, 5, 0);
	T = trans[1][70] = settr(119,2,0,0,0,"IF", 1, 5, 0);
	T = T->nxt	= settr(119,2,62,0,0,"IF", 1, 5, 0);
	    T->nxt	= settr(119,2,68,0,0,"IF", 1, 5, 0);
	trans[1][62]	= settr(111,2,66,113,113,"(!(lock_is_occupied[lockid]))", 1, 5, 0); /* m: 63 -> 66,0 */
	reached1[63] = 1;
	...
	trans[1][66]	= settr(115,2,67,114,114,"observed_low[lockid]!1", 1, 5, 0);
	trans[1][67]	= settr(116,0,116,1,0,"goto :b4", 1, 5, 0);
	trans[1][71]	= settr(120,0,79,1,0,".(goto)", 1, 5, 0);
	trans[1][68]	= settr(117,2,69,115,0,"(lock_is_occupied[lockid])", 1, 5, 0);
	trans[1][69]	= settr(118,2,71,116,116,"observed_low[lockid]!1", 1, 5, 0);
	T = trans[ 1][78] = settr(127,2,0,0,0,"ATOMIC", 1, 2, 0);
	T->nxt	= settr(127,2,73,0,0,"ATOMIC", 1, 2, 0);
	trans[1][73]	= settr(122,4,116,117,117,"(((doors_status[lockid].lower==1)&&!(lock_is_occupied[lockid])))", 1, 2, 0); /* m: 74 -> 116,0 */
	reached1[74] = 1;
	...
	trans[1][82]	= settr(131,0,107,118,0,"((ship_status[shipid]==2))", 1, 2, 0);
	...
	trans[1][83]	= settr(132,0,84,119,0,"((doors_status[lockid].higher==2))", 1, 2, 0);
	trans[1][84]	= settr(133,0,85,120,120,"request_high!1,lockid", 1, 4, 0);
	trans[1][85]	= settr(134,0,86,121,121,"requested_lock = lockid", 1, 2, 0);
	trans[1][86]	= settr(135,0,99,122,122,"high_req[lockid] = 1", 1, 2, 0);
	T = trans[ 1][99] = settr(148,2,0,0,0,"ATOMIC", 1, 2, 0);
	T->nxt	= settr(148,2,87,0,0,"ATOMIC", 1, 6, 0);
	trans[1][87]	= settr(136,2,97,123,0,"((doors_status[lockid].higher==1))", 1, 6, 0);
	T = trans[1][97] = settr(146,2,0,0,0,"IF", 1, 6, 0);
	T = T->nxt	= settr(146,2,88,0,0,"IF", 1, 6, 0);
	    T->nxt	= settr(146,2,95,0,0,"IF", 1, 6, 0);
	trans[1][88]	= settr(137,2,93,124,124,"(((nr_of_ships_at_pos[(ship_pos[shipid]+1)]<2)||((ship_pos[shipid]+1)==3)))", 1, 6, 0); /* m: 89 -> 93,0 */
	reached1[89] = 1;
	...
	trans[1][93]	= settr(142,2,94,125,125,"observed_high[0]!1", 1, 6, 0);
	trans[1][94]	= settr(143,0,116,1,0,"goto :b5", 1, 6, 0);
	trans[1][98]	= settr(147,0,107,1,0,".(goto)", 1, 6, 0);
	trans[1][95]	= settr(144,2,96,126,0,"(((nr_of_ships_at_pos[(ship_pos[shipid]+1)]==2)&&((ship_pos[shipid]+1)!=3)))", 1, 6, 0);
	trans[1][96]	= settr(145,2,98,127,127,"observed_high[0]!1", 1, 6, 0);
	T = trans[ 1][106] = settr(155,2,0,0,0,"ATOMIC", 1, 2, 0);
	T->nxt	= settr(155,2,100,0,0,"ATOMIC", 1, 2, 0);
	trans[1][100]	= settr(149,4,116,128,128,"(((doors_status[lockid].higher==1)&&((nr_of_ships_at_pos[(ship_pos[shipid]+1)]<2)||((ship_pos[shipid]+1)==3))))", 1, 2, 0); /* m: 101 -> 116,0 */
	reached1[101] = 1;
	...
	trans[1][110]	= settr(159,0,111,129,0,"(((ship_status[shipid]==5)&&(ship_pos[shipid]==0)))", 1, 2, 0);
	trans[1][111]	= settr(160,0,112,130,130,"ship_status[shipid] = 1", 1, 2, 0);
	trans[1][112]	= settr(161,0,116,131,131,"ship_status[shipid] = 3", 1, 2, 0);
	trans[1][113]	= settr(162,0,114,132,0,"(((ship_status[shipid]==3)&&(ship_pos[shipid]==3)))", 1, 2, 0);
	trans[1][114]	= settr(163,0,115,133,133,"ship_status[shipid] = 1", 1, 2, 0);
	trans[1][115]	= settr(164,0,116,134,134,"ship_status[shipid] = 5", 1, 2, 0);
	trans[1][118]	= settr(167,0,119,1,0,"break", 0, 2, 0);
	trans[1][119]	= settr(168,0,0,135,135,"-end-", 0, 3500, 0);
	...
	trans[0][1]	= settr(0,0,7,136,136,"change_doors_pos[lockid]?2", 1, 507, 0);
	T = trans[0][7] = settr(6,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(6,0,2,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(6,0,5,0,0,"IF", 0, 2, 0);
	trans[0][2]	= settr(1,0,3,137,0,"((doors_status[lockid].lower==2))", 1, 2, 0);
	trans[0][3]	= settr(2,0,4,138,138,"doors_status[lockid].lower = 1", 1, 2, 0);
	trans[0][4]	= settr(3,0,9,139,139,"lock_water_level[lockid] = 2", 1, 2, 0);
	trans[0][8]	= settr(7,0,9,1,0,".(goto)", 0, 2, 0);
	trans[0][5]	= settr(4,0,6,140,0,"((doors_status[lockid].lower==1))", 1, 2, 0);
	trans[0][6]	= settr(5,0,9,141,141,"doors_status[lockid].lower = 2", 1, 2, 0);
	trans[0][9]	= settr(8,0,47,142,142,"doors_pos_changed[lockid]!1", 1, 8, 0);
	trans[0][10]	= settr(9,0,21,143,143,"change_doors_pos[lockid]?1", 1, 507, 0);
	T = trans[0][21] = settr(20,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(20,0,11,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(20,0,19,0,0,"IF", 0, 2, 0);
	trans[0][11]	= settr(10,0,12,144,0,"((doors_status[lockid].higher==2))", 1, 2, 0);
	trans[0][12]	= settr(11,0,17,145,145,"doors_status[lockid].higher = 1", 1, 2, 0);
	T = trans[0][17] = settr(16,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(16,0,13,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(16,0,15,0,0,"IF", 0, 2, 0);
	trans[0][13]	= settr(12,0,14,146,0,"(((doors_status[lockid].lower==2)&&(slide_status[lockid].lower==2)))", 1, 2, 0);
	trans[0][14]	= settr(13,0,23,147,147,"lock_water_level[lockid] = 1", 1, 2, 0);
	trans[0][18]	= settr(17,0,23,1,0,".(goto)", 0, 2, 0);
	trans[0][15]	= settr(14,0,16,148,0,"(((doors_status[lockid].lower==1)||(slide_status[lockid].lower==1)))", 1, 2, 0);
	trans[0][16]	= settr(15,0,23,1,0,"(1)", 0, 2, 0);
	trans[0][22]	= settr(21,0,23,1,0,".(goto)", 0, 2, 0);
	trans[0][19]	= settr(18,0,20,149,0,"((doors_status[lockid].higher==1))", 1, 2, 0);
	trans[0][20]	= settr(19,0,23,150,150,"doors_status[lockid].higher = 2", 1, 2, 0);
	trans[0][23]	= settr(22,0,47,151,151,"doors_pos_changed[lockid]!1", 1, 8, 0);
	trans[0][24]	= settr(23,0,30,152,152,"change_slide_pos[lockid]?2", 1, 509, 0);
	T = trans[0][30] = settr(29,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(29,0,25,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(29,0,28,0,0,"IF", 0, 2, 0);
	trans[0][25]	= settr(24,0,26,153,0,"((slide_status[lockid].lower==2))", 1, 2, 0);
	trans[0][26]	= settr(25,0,27,154,154,"slide_status[lockid].lower = 1", 1, 2, 0);
	trans[0][27]	= settr(26,0,32,155,155,"lock_water_level[lockid] = 2", 1, 2, 0);
	trans[0][31]	= settr(30,0,32,1,0,".(goto)", 0, 2, 0);
	trans[0][28]	= settr(27,0,29,156,0,"((slide_status[lockid].lower==1))", 1, 2, 0);
	trans[0][29]	= settr(28,0,32,157,157,"slide_status[lockid].lower = 2", 1, 2, 0);
	trans[0][32]	= settr(31,0,47,158,158,"slide_pos_changed[lockid]!1", 1, 10, 0);
	trans[0][33]	= settr(32,0,44,159,159,"change_slide_pos[lockid]?1", 1, 509, 0);
	T = trans[0][44] = settr(43,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(43,0,34,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(43,0,42,0,0,"IF", 0, 2, 0);
	trans[0][34]	= settr(33,0,35,160,0,"((slide_status[lockid].higher==2))", 1, 2, 0);
	trans[0][35]	= settr(34,0,40,161,161,"slide_status[lockid].higher = 1", 1, 2, 0);
	T = trans[0][40] = settr(39,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(39,0,36,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(39,0,38,0,0,"IF", 0, 2, 0);
	trans[0][36]	= settr(35,0,37,162,0,"(((doors_status[lockid].lower==2)&&(slide_status[lockid].lower==2)))", 1, 2, 0);
	trans[0][37]	= settr(36,0,46,163,163,"lock_water_level[lockid] = 1", 1, 2, 0);
	trans[0][41]	= settr(40,0,46,1,0,".(goto)", 0, 2, 0);
	trans[0][38]	= settr(37,0,39,164,0,"(((doors_status[lockid].lower==1)||(slide_status[lockid].lower==1)))", 1, 2, 0);
	trans[0][39]	= settr(38,0,46,1,0,"(1)", 0, 2, 0);
	trans[0][45]	= settr(44,0,46,1,0,".(goto)", 0, 2, 0);
	trans[0][42]	= settr(41,0,43,165,0,"((slide_status[lockid].higher==1))", 1, 2, 0);
	trans[0][43]	= settr(42,0,46,166,166,"slide_status[lockid].higher = 2", 1, 2, 0);
	trans[0][46]	= settr(45,0,47,167,167,"slide_pos_changed[lockid]!1", 1, 10, 0);
	trans[0][49]	= settr(48,0,50,1,0,"break", 0, 2, 0);
	trans[0][50]	= settr(49,0,0,168,168,"-end-", 0, 3500, 0);
	/* np_ demon: */
